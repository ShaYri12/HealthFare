  ...
  en: {
    translation: {
      ...
      error: {
        ...
        currentMedicationsError: "Please specify if you are currently taking any medications.",
        medicationAllergiesError: "Please indicate if you have any allergies to medications.",
        dietarySupplementsError: "Please confirm if you are taking any prescription or over-the-counter diet aids.",
        currentAntibioticsError: "Please state if you are currently taking any antibiotics.",
        weightLossMedicationsError: "Please mention if you have taken any weight loss medications before.",
        healthConditionsError: "Please select at least one health condition. If none, select ‘None’.",
      },
      loading: {
      ...
      stepTen: {
        ...
        addonSectionTitle:"Would you like to add any additional medicines to your order?",
        ...
        addons: {
          ...
          title2: "Medicine2",
          addon2Desc:
            "Enhance your weight loss journey with Medicine2 by preventing nausea often experienced with Semaglutide and Tirzepatide. Medicine2 helps you stay on track and potentially lose up to 10 pounds more effectively.",
        },
      ...
      stepTwelve: {
        ...
        chooseTime: "Please select a time to consult with our licensed provider",
      ...
      thankYou: {
        ...
        appointmentDetails: "Your appointment details are as follows:",
        date: "Date",
        time: "Time",
  ...
  es: {
    translation: {
      ...
      error: {
        ...
        streetAddressError: "Por favor, ingrese su dirección (por ejemplo, 123 Main Street).",
        cityError: "Por favor, ingrese su ciudad (por ejemplo, Los Ángeles).",
        zipCodeError: "Por favor, ingrese su código postal (por ejemplo, 90001).",
        ...
        ageError: "Debe tener al menos 18 años para participar en el programa de pérdida de peso de HealthFare.",
        phoneFillError: "Por favor, ingrese su número de teléfono.",
        phoneError: "Por favor, ingrese un número de teléfono válido en el formato (000) 000-0000.",
        phoneDigitsError: "El número de teléfono debe tener al menos 10 dígitos.",
        emailRequiredError: "Por favor, ingrese su dirección de correo electrónico.",
        emailInvalidError: "Esta no es una dirección de correo electrónico válida. Por favor, ingrese una dirección de correo electrónico válida.",
        smsNotificationError: "Por favor, seleccione si prefiere recibir notificaciones por SMS.",
        disqualifyTitle: "LAMENTABLEMENTE, NO ERES ELEGIBLE.",
        disqualifyMsg: "No cumple con los requisitos para ser elegible para este programa. Por favor, contáctenos si necesita más ayuda.",
        currentMedicationsError: "Por favor, especifique si actualmente está tomando algún medicamento.",
        medicationAllergiesError: "Por favor, indique si tiene alguna alergia a medicamentos.",
        dietarySupplementsError: "Por favor, confirme si está tomando algún suplemento dietético recetado o de venta libre.",
        currentAntibioticsError: "Por favor, indique si actualmente está tomando algún antibiótico.",
        weightLossMedicationsError: "Por favor, mencione si ha tomado algún medicamento para la pérdida de peso antes.",
        healthConditionsError: "Por favor, seleccione al menos una condición de salud. Si no tiene ninguna, seleccione 'Ninguna'.",
      },
      loading: {
      ...
      planSelection: {
        ...
        note: "Nota: El suministro de 3 meses ofrece una tarifa con descuento de",
        billed: "facturado como un pago único de",
      ...
      stepTen: {
        ...
        addonSectionTitle: "¿Te gustaría añadir algún medicamento adicional a tu pedido?",
        ...
        addons: {
          ...
          title2: "Medicine2",
          addon2Desc:
            "Mejora tu viaje de pérdida de peso con Medicine2, previniendo las náuseas frecuentemente experimentadas con Semaglutida y Tirzepatida. Medicine2 te ayuda a mantener el rumbo y potencialmente a perder hasta 10 libras de manera más efectiva..",
        },
      ...
      stepTwelve: {
        ...
        chooseTime: "Por favor, seleccione una hora para consultar con nuestro proveedor licenciado",
  ...
  pt: {
    translation: {
      ...
      error: {
        ...
        streetAddressError: "Por favor, insira seu endereço (por exemplo, 123 Main Street).",
        cityError: "Por favor, insira sua cidade (por exemplo, Los Angeles).",
        zipCodeError: "Por favor, insira seu código postal (por exemplo, 90001).",
        stateMismatchError: "O estado deve coincidir com o selecionado no início do questionário.",
        ...
        emailInvalidError: "Este não é um endereço de e-mail válido. Por favor, insira um endereço de e-mail válido.",
        ...
        currentMedicationsError: "Por favor, especifique se você está tomando algum medicamento atualmente.",
        medicationAllergiesError: "Por favor, indique se você tem alguma alergia a medicamentos.",
        dietarySupplementsError: "Por favor, confirme se você está tomando algum suplemento dietético prescrito ou de venda livre.",
        currentAntibioticsError: "Por favor, indique se você está tomando algum antibiótico atualmente.",
        weightLossMedicationsError: "Por favor, mencione se você já tomou algum medicamento para perda de peso antes.",
        healthConditionsError: "Por favor, selecione pelo menos uma condição de saúde. Se não tiver nenhuma, selecione 'Nenhuma'.",
      },
      loading: {
        ...
        cards: [
          {
            ...
            titleDesc: "Semaglutida, o ingrediente ativo em Ozempic® e Wegovy®.",
            injection: "Injeção de 5mg / mL",
            description: "Perda de até 10 libras por mês.",
            description2: "Perda de até 30 libras",
          ...
          },
          {
            ...
            titleDesc: "Tirzepatida, o mesmo ingrediente ativo em Mounjaro® e Zepbound™",
            injection: "Injeção de 10mg / mL",
            description: "Perda de até 16 libras por mês.",
            description2: "Perda de até 48 libras",
            feature1: "Inclui Provedor e Medicação. Sem custos ocultos. Não é necessário seguro.",
            feature2: "Enriquecido com Vitamina B-12 e Glicina.",
          },
        ],
      ...
      planSelection: {
        ...
        description: "Com que frequência você deseja que seu tratamento seja enviado?",
      ...
      stepTen: {
        ...
        addons: {
          ...
          title2: "Medicine2",
          addon2Desc:
            "Melhore sua jornada de perda de peso com Medicine2, prevenindo náuseas frequentemente experimentadas com Semaglutida e Tirzepatida. Medicine2 ajuda você a manter o foco e potencialmente perder até 10 libras de forma mais eficaz.",
        },
      ...
      stepTwelve: {
        ...
        chooseTime: "Por favor, selecione um horário para consultar com nosso provedor licenciado",
